...
static struct gpu_param_table gpu_params[] = {
	...
	/* 1x88: 1088/1T88/1L88/1U88 */
	MAKE_GPU_PARAM_X("1x88", 40, 0xC0400000, 0x1000, 0x4000000, 0x0),
	/* pxa1928 */
	MAKE_GPU_PARAM_X("pxa1928", 113, 0xd420d000 , 0x1000, 0x4000000, 0x0),
	/* 1986 */
	MAKE_GPU_PARAM_X("adir", 41, 0xf0800000, 0x1000, 0x4000000, 0x0),
};
...
static int __init __prepare_gpu_resources(void)
{
	...
	/* hack for helan2 + GC5.x */
	if (cpu_is_pxa1U88())
		gpu_reserve_pa = 0x09000000;
