...
#define CPMU_DBG1		0x1200

#define CURR_REF_PU		0x1

/* AP Core n Reset Control Register */
#define PMUA_SW_WAKEUP				(0x1 << 16)
#define PMUA_CORE_RSTCTRL_CPU_ETM_NRESET	(0x1 << 5)
#define PMUA_CORE_RSTCTRL_CPU_DBG_NRESET	(0x1 << 4)
...
#if defined(CONFIG_EDEN_SOC_TIMER1)
#define PMUA_TIMER_WK_MSK	PMUA_TIMER_1_1
#elif defined(CONFIG_EDEN_SOC_TIMER2)
