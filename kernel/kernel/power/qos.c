...
static BLOCKING_NOTIFIER_HEAD(vpu2_devfreq_min_notifier);
static struct pm_qos_constraints vpu2_devfreq_min_constraints = {
	.list = PLIST_HEAD_INIT(vpu2_devfreq_min_constraints.list),
	.target_value = PM_QOS_DEFAULT_VALUE,
	.default_value = PM_QOS_DEFAULT_VALUE,
	.type = PM_QOS_MAX,
	.notifiers = &vpu2_devfreq_min_notifier,
};
static struct pm_qos_object vpu2_devfreq_min_pm_qos = {
	.constraints = &vpu2_devfreq_min_constraints,
	.name = "vpu2_devfreq_min",
};

static BLOCKING_NOTIFIER_HEAD(vpu2_devfreq_max_notifier);
static struct pm_qos_constraints vpu2_devfreq_max_constraints = {
	.list = PLIST_HEAD_INIT(vpu2_devfreq_max_constraints.list),
	.target_value = PM_QOS_DEFAULT_VALUE,
	.default_value = INT_MAX,
	.type = PM_QOS_MIN,
	.notifiers = &vpu2_devfreq_max_notifier,
};
static struct pm_qos_object vpu2_devfreq_max_pm_qos = {
	.constraints = &vpu2_devfreq_max_constraints,
	.name = "vpu2_devfreq_max",
};
...
struct pm_qos_object *pm_qos_array[] = {
	...
	&cpu_num_min_pm_qos,
	&cpu_num_max_pm_qos,
	&vpu2_devfreq_min_pm_qos,
	&vpu2_devfreq_max_pm_qos,
};
