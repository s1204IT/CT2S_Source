/*
 * mma8452.c
 * - Support for Freescale MMA8452Q/MMA8652FC 3-axis 12-bit accelerometer
 *
...
/* copy from include/linux/iio/buffer.h of 3.18.1 */
			 ...
			 const struct i2c_device_id *id)
{
	...
	if (ret < 0)
		return ret;
	if ((ret != MMA8452_DEVICE_ID) && (ret != MMA8652_DEVICE_ID))
		return -ENODEV;
