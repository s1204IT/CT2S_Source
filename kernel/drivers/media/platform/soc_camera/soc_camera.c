...
#define SOC_DRV_NAME         "soc-drv"

static LIST_HEAD(hosts);
static LIST_HEAD(devices);
static DEFINE_MUTEX(list_lock);		/* Protects the list of hosts */

static struct pm_qos_request soc_qos_idle;
			       ...
			       enum v4l2_buf_type i)
{
	...
	soc_qos_idle.name = SOC_DRV_NAME;
        pm_qos_add_request(&soc_qos_idle, PM_QOS_CPU_DMA_LATENCY, 50);
				...
				enum v4l2_buf_type i)
{
	...
	pm_qos_remove_request(&soc_qos_idle);
