...
enum mcu_cmd_src_type {
	CMD_SRC_NONE = 0,
	CMD_SRC_PRIMARY_SNSR,
	CMD_SRC_SECONDAY_SNSR,
	CMD_SRC_AXI,
};
...
int b52_ack_xlate_irq(__u32 *events);
...
/* Output Information */
#define REG_OI_PREVIEW_CROPX        (0x3c)
#define REG_OI_PREVIEW_CROPY        (0x3e)
#define REG_OI_VIDEO1_CROPX         (0x40)
#define REG_OI_VIDEO1_CROPY         (0x42)
#define REG_OI_VIDEO2_CROPX         (0x44)
#define REG_OI_VIDEO2_CROPY         (0x46)
#define REG_OI_SHARPNESS            (0x48)
