...
static void ccic_config_idi(struct ccic_ctrl_dev *ctrl_dev, int sel)
{
	...
	case SC2_IDI_SEL_DPCM:
		...
		ccic_reg_set_bit(ccic_dev,
				REG_CSI2_CTRL2, CSI2_C2_IDI_MUX_SEL_DPCM);
		ccic_reg_set_bit(ccic_dev, REG_CSI2_CTRL2, CSI2_C2_DPCM_DT_15TO8);
		ccic_reg_set_bit(ccic_dev, REG_CSI2_CTRL2, CSI2_C2_DPCM_DT_5TO0_SW);
		ccic_reg_set_bit(ccic_dev, REG_CSI2_CTRL2, CSI2_C2_DPCM_DT_5TO0);
