...
struct regval_tab ov13850r2a_res_init[] = {
	{0x0103, 0x01},
...
struct regval_tab ov13850r2a_res_4M[] = {
};

struct regval_tab ov13850r2a_res_8M[] = {
};
...
struct regval_tab ov13850r2a_vcm_id[] = {
	{0x00, 0xF4, 0xff},
};
struct regval_tab ov13850r2a_vcm_init[] = {
	/* control register */
	{0x02, 0x02, 0x03},
	/* mode register */
	{0x06, 0x00, 0xC0},
...
#define N_OV13850R2A_INIT ARRAY_SIZE(ov13850r2a_res_init)
#define N_OV13850R2A_ID ARRAY_SIZE(ov13850r2a_id)
#define N_OV13850R2A_VCM_ID ARRAY_SIZE(ov13850r2a_vcm_id)
#define N_OV13850R2A_VCM_INIT ARRAY_SIZE(ov13850r2a_vcm_init)
#define N_OV13850R2A_FMT_RAW10 ARRAY_SIZE(ov13850r2a_fmt_raw10)
#define N_OV13850R2A_13M ARRAY_SIZE(ov13850r2a_res_13M)
#define N_OV13850R2A_4M ARRAY_SIZE(ov13850r2a_res_4M)
#define N_OV13850R2A_8M ARRAY_SIZE(ov13850r2a_res_8M)
...
struct b52_sensor_resolution ov13850r2a_res[] = {
	[0] = {
		 .width = 4224,
		 .height = 3136,
		 .hts = 0x12c0,
...
static struct b52_sensor_vcm vcm_dw9761 = {
	.name = "dw9761",
	.type = VCM_DW9761,
	.attr = &vcm_attr,
	.pos_reg_msb = 0x03,
	.pos_reg_lsb = 0x04,
	.id = {
		.tab = ov13850r2a_vcm_id,
		.num = N_OV13850R2A_VCM_ID,
	},
	.init = {
		.tab = ov13850r2a_vcm_init,
		.num = N_OV13850R2A_VCM_INIT,
	},
};
static struct b52_sensor_module ov13850r2a_ofilm = {
	.vcm = &vcm_dw9761,
	.id = 7,
};
...
struct b52_sensor_data b52_ov13850r2a = {
	.name = "ovt.ov13850r2a",
	.type = OVT_SENSOR,
	.chip_ident = V4L2_IDENT_OV13850R2A,
	...
	.global_setting = {
		.tab = ov13850r2a_res_init,
		.num = N_OV13850R2A_INIT,
	},
