/*
 *  linux/drivers/clk/mmp/dvfs-pxa1088.c
 *
 *
...
static unsigned long freqs_cmb_1088[][VL_MAX] = {
	...
	{156000, 312000, 312000, 533000},	/* DDR/AXI */
...
static int vm_mv_1088_svc_1p2G[][VL_MAX] = {
	...
	{1025, 1075, 1088, 1225},	/* profile 1 */
	{1025, 1075, 1088, 1225},	/* profile 2 */
	{1025, 1075, 1088, 1238},	/* profile 3 */
	{1025, 1075, 1125, 1288},	/* profile 4 */
	{1025, 1075, 1150, 1325},	/* profile 5 */
	{1025, 1075, 1188, 1363},	/* profile 6 */
...
static struct dvfs_rail_component vm_rail_comp_tbl_dvc[] = {
	...
	INIT_DVFS("SDH0", true,
		  (AFFECT_RAIL_ACTIVE | AFFECT_RAIL_M2 | AFFECT_RAIL_D1P),
		  &freqs_cmb_1088[SDH0][0]),
	INIT_DVFS("SDH1", true,
		  (AFFECT_RAIL_ACTIVE | AFFECT_RAIL_M2 | AFFECT_RAIL_D1P),
		  &freqs_cmb_1088[SDH1][0]),
	INIT_DVFS("SDH2", true,
		  (AFFECT_RAIL_ACTIVE | AFFECT_RAIL_M2 | AFFECT_RAIL_D1P),
		  &freqs_cmb_1088[SDH2][0]),
