...
#define PXA1928_PLL_SSC_EN	BIT(1)
#define PXA1928_PLL_SSC_DOWN_MODE	BIT(2)
#define PXA1928_PLL_SSC_ALWAYS_EN	BIT(3)
#define PXA1928_PLL_PWR_CTRL	BIT(4)
