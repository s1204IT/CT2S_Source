...
static unsigned long freqs_cmb_1L88a0[][VL_MAX] = {
	...
	{ DUMMY_VL_TO_KHZ(VL0), DUMMY_VL_TO_KHZ(VL1), DUMMY_VL_TO_KHZ(VL2), DUMMY_VL_TO_KHZ(VL3) }, /* SDH0 */
	{ DUMMY_VL_TO_KHZ(VL0), DUMMY_VL_TO_KHZ(VL1), DUMMY_VL_TO_KHZ(VL2), DUMMY_VL_TO_KHZ(VL3) }, /* SDH1 */
	{ DUMMY_VL_TO_KHZ(VL0), DUMMY_VL_TO_KHZ(VL1), DUMMY_VL_TO_KHZ(VL2), DUMMY_VL_TO_KHZ(VL3) }, /* SDH2 */
};
...
static unsigned long freqs_cmb_1L88a0c[VM_RAIL_MAX][VL_MAX] = {
	...
	{ DUMMY_VL_TO_KHZ(VL0), DUMMY_VL_TO_KHZ(VL1), DUMMY_VL_TO_KHZ(VL2), DUMMY_VL_TO_KHZ(VL3), DUMMY_VL_TO_KHZ(VL3 + 1) }, /* SDH0 */
	{ DUMMY_VL_TO_KHZ(VL0), DUMMY_VL_TO_KHZ(VL1), DUMMY_VL_TO_KHZ(VL2), DUMMY_VL_TO_KHZ(VL3), DUMMY_VL_TO_KHZ(VL3 + 1) }, /* SDH1 */
	{ DUMMY_VL_TO_KHZ(VL0), DUMMY_VL_TO_KHZ(VL1), DUMMY_VL_TO_KHZ(VL2), DUMMY_VL_TO_KHZ(VL3), DUMMY_VL_TO_KHZ(VL3 + 1) }, /* SDH2 */
};
...
static int __init setup_pxa1L88_dvfs_platinfo(void)
{
	...
	plat_set_vl_min(0);
	plat_set_vl_max(dvc_pxa1L88_info.num_volts);
