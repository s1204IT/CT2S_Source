...
static void antenna_ldo_control(int enable)
{
	...
	if (m3_regulator.reg_ant) {
		...
		if (enable) {
			...
			regulator_set_voltage(m3_regulator.reg_ant, 3100000, 3100000);
...
static void sensor_ldo_control(int enable)
{
	...
	if (m3_regulator.reg_sen) {
		...
		if (enable) {
			...
			regulator_set_voltage(m3_regulator.reg_sen, 2800000, 2800000);
...
static void gps_ldo_control(int enable)
{
	...
	if (m3_regulator.reg_vm3) {
		...
		if (enable) {
			...
			regulator_set_voltage(m3_regulator.reg_vm3, 1800000, 1800000);
