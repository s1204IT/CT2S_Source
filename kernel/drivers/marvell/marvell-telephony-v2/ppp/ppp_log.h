...
#define PPP_LOG()			PppAddLogEntry(localLogType, \
	__LINE__, 0)
#define PPP_LOG_1(v1)			PppAddLogEntry(localLogType, \
	__LINE__, 1, (v1))
#define PPP_LOG_2(v1, v2)		PppAddLogEntry(localLogType, \
	__LINE__, 2, (v1), (v2))
#define PPP_LOG_3(v1, v2, v3)		PppAddLogEntry(localLogType, \
	__LINE__, 3, (v1), (v2), (v3))
#else
#define PPP_LOG()
#define PPP_LOG_1(v1)
