...
TRACE_EVENT(surface,
	...
	TP_printk("surface overlay: %d, addr: 0x%x, pitch: 0x%x, xsrc: %d,"
		" ysrc: %d, xpos: %d, ypos: %d, fmt: 0x%x",
...
TRACE_EVENT(win,
	...
	TP_printk("%s window overlay: %d, pitch: 0x%x, xsrc: %d, ysrc: %d,"
		" xpos: %d, ypos: %d, fmt: 0x%x",
...
TRACE_EVENT(fence,
	...
	TP_printk("fence %s, name=%s, obj=0x%lx, overlay=%d, value=%s,"
		" commit=%d, frame=%d",
