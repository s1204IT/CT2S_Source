...
#define LSM9DS1_M_POLL_INTERVAL_DEF	(20)
...
#define LSM9DS1_INT1_GPIO_DEF		(190)
#define LSM9DS1_INT2_GPIO_DEF		(191)
...
#define LSM9DS1_GYR_POLL_INTERVAL_DEF	(10)
#define LSM9DS1_ACC_POLL_INTERVAL_DEF	(10)
