...
extern void hantro_power_switch(unsigned int enable, int);
extern void enable_smmu_power_domain(struct device *, int, int);
extern struct mutex vpu_pw_fc_lock;
#ifdef CONFIG_ARM64
extern int hantro_pwr_refcnt;
#endif
#endif
