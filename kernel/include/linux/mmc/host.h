 ...
 */
#define MMC_CAP2_DISABLE_PROBE_CDSCAN  (1 << 16)
#define MMC_CAP2_BUS_AUTO_CLK_GATE (1 << 17)   /* host can auto gate bus clk */
#define MMC_CAP2_NO_VOLTAGE_SWITCH (1 << 18)   /* Don't need voltage switch */
#define MMC_CAP2_BKOPS_EN	(1 << 19)	/* Enable bkops from host side */
